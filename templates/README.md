...
The pipeline turns the JSON source tree into a flat SQLite catalog consumed by
the mobile app:
...
- JSON Schema: [`schemas/template-v2.json`](schemas/template-v2.json)
- Pipeline details: `docs/docs/developer/data-pipeline.md` (in the docs site)